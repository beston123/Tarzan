...
import com.tongbanjie.tevent.store.mapper.MessageAggregatePlanMapper;
import com.tongbanjie.tevent.store.model.AggregateType;
import com.tongbanjie.tevent.store.model.AggregateStatus;
...
public class MessageAggregatePlanService {
    ...
    public Result<List<MessageAggregatePlan>> getToDo(MQType mqType, AggregateType aggregateType){
        ...
        if(query.getPagingParam() == null){
            query.setPagingParam(new PagingParam(10000));
        }
